...
class TwoInts() : TwoIntsAdder {
    /**
     * Demonstrate the all parameters have default value from the base interface in Kotlin
     *
    ...
    /**
     * Demonstrate the some parameters have default value from the base interface in Kotlin
     *
     * @author Ranjith Krishnamurthy
     */
    ...
    /**
     * Demonstrate no default value from the base interface in Kotlin
     *
     * @author Ranjith Krishnamurthy
     */

...
/**
 * Demonstrate the structural and referential equality on the class that does not implement equals and hashcode in Kotlin
 *
 * Note:
 * 1. In this case, structural equality behave like a referential equality
 * 2. Structural equality uses default Any's equals method that behaves like a referential equality
